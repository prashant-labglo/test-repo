"""
RestClient.py defines the base class for all REST clients.
"""
import sys
import urllib
...
class RestClient(object):
    """
        RestClient.py defines the base class for all REST clients.
    """
    def __init__(self, baseURL, reqs_per_sec=15):
        """
    ...
    def perform_rest_action(self, endpoint, hdrs=None, params=None):
        """
        Method to call REST API client.
        """
        if hdrs is None:
            hdrs = {}
        ...
        try:
            request = urllib2.Request(self.baseURL + endpoint, headers=hdrs)
...
def test(species, symbol):
    """
    Unit test for REST client class.
    """
